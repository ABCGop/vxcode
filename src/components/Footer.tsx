        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Collaborate with Intelligence. AI-powered IDE for the modern developer.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/download" className="text-gray-400 hover:text-white transition-colors">Downloads</a></li>
            </ul>
          </div>
